...
const brandMark = readSource('components/site/BrandMark.tsx')
...
describe('stakeholder interaction polish', () => {
  ...
  it('keeps the revised public pages clear, compact, and easy to navigate', () => {
    ...
    expect(familiesIntro).toContain('friendly-card--link')
    expect(globals).toContain('.friendly-card--link:hover')
    expect(globals).toContain('.hero-content {')
